...
copied from klindsay,
https://github.com/klindsay28/CESM2_coup_carb_cycle_JAMES/blob/master/utils.py   # noqa: E501
"""
...
def clean_units(units):
    ...
    units_split = re.split("( |\(|\)|\^|\*|/|-[0-9]+|[0-9]+)", units)  # noqa: W605
    units_split_repl = [
...
def time_set_mid(ds, time_name):
    """
    set ds[time_name] to midpoint of ds[time_name].attrs['bounds'],
    if bounds attribute exists type of ds[time_name] is not changed
    ds is returned
    """
...
def time_year_plus_frac(ds, time_name):
    ...
    # this is straightforward if time has
    # units='days since 0000-01-01' and calendar='noleap'
...
def cyclic_dataarray(da, coord="lon"):
    ...
    cyclic_data, cyclic_coord = add_cyclic_point(
